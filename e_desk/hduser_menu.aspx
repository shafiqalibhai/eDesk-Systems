<%@ Page Language="vb" AutoEventWireup="false" Inherits="e_desk.hduser_menu" CodeFile="hduser_menu.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>hduser_menu</title>
	...
	<body bgColor="#fffaf0">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Label id="Label1" style="Z-INDEX: 102; LEFT: 32px; POSITION: absolute; TOP: 40px" runat="server"
				Height="24px" Width="208px" Font-Size="12pt" Font-Names="Verdana" Font-Bold="True" ForeColor="#804000">HELP DESK USER MENU</asp:Label>
		</form>
	</body>
</HTML>
